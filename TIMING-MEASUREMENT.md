...
[`single_board_test_firmwares/src/main.rs`](single_board_test_firmwares/src/main.rs).
...
- [x] **First real ISR** in `single_board_test_firmwares` via `#[msp430_rt::interrupt] fn
